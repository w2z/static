...
Download_caddy(){
	...
	if [[ ${bit} == "x86_64" ]]; then
		wget --no-check-certificate -O "caddy_linux.tar.gz" "https://hub.fastgit.org/caddyserver/caddy/releases/download/v1.0.3/caddy_v1.0.3_linux_amd64.tar.gz"
	elif [[ ${bit} == "i386" || ${bit} == "i686" ]]; then
		wget --no-check-certificate -O "caddy_linux.tar.gz" "https://hub.fastgit.org/caddyserver/caddy/releases/download/v1.0.3/caddy_v1.0.3_linux_386.tar.gz"
	elif [[ ${bit} == "armv7l" ]]; then
		wget --no-check-certificate -O "caddy_linux.tar.gz" "https://hub.fastgit.org/caddyserver/caddy/releases/download/v1.0.3/caddy_v1.0.3_linux_arm7.tar.gz"
	else
